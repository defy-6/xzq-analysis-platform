...
export default function TransportAccessibilityModule(){
  ...
  const reverse=selected?allFlows.find(flow=>flow.oc===selected.dc&&flow.oCounty===selected.dCounty&&flow.o===selected.d&&flow.dc===selected.oc&&flow.dCounty===selected.oCounty&&flow.d===selected.o):null;
